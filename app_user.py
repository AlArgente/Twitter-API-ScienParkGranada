...
from utils import format_time_sql,  get_tweets_by_hashtag, get_tweets_for_username
# from user_pages import hashtag_info, user_info
from utils_app import generate_table, generate_timeline_user, generate_pie_chart, generate_pie_chart_less, generate_pie_char_tweets_user, get_num_pos_neg_neu_from_df
...
def update_graph_live_user(n, input_user):
    ...
    user_df = get_tweets_for_username(input_user, listener=client_listener, clf=classifier, max_results=100)
...
def update_graph_live_hashtag(n, input_hashtag):
    ...
    # Create the graph once data is loaded
    hashtag_df = get_tweets_by_hashtag(api, classifier, input_hashtag, max_tweets=1000)
